...
} LoRaModes[] =
{
	...
	{IMPLICIT_MODE, ERROR_CODING_4_5, BANDWIDTH_250K, SPREADING_12,  0,  540, "Own SF12"},		// 9: Own Mode with SF12
	{IMPLICIT_MODE, ERROR_CODING_4_5, BANDWIDTH_250K, SPREADING_11,  0,  1000, "Own SF11"},		// 10: Own Mode with SF11
};
...
void LoadLoRaConfig(FILE *fp, struct TConfig *Config)
{
	...
	if (Config->BoardType)
	{
		...
		//DIO0 and DIO5 pins get changed from the pisky.txt file, so no need for a change here
